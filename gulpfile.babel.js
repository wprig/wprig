...
export const buildDev = parallel(
    php, images, sprites, series( styles, editorStyles ), scripts, translate
);
...
export const bundleTheme = series(
    prodPrep, parallel(php, scripts, sprites, series( styles, editorStyles ), images), translate, prodStringReplace, prodCompress
);

/**
 * Export all imported functions as tasks
 */
export { generateCert, images, php, scripts, styles, sprites, editorStyles, translate, watch, cleanCSS, cleanJS };
