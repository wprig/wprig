<?php
/**
 * WP_Rig\WP_Rig\Tests\Unit\Sidebars\Component_Test class
 *
 * @package wp_rig
 */

namespace WP_Rig\WP_Rig\Tests\Unit\Sidebars;

use WP_Rig\WP_Rig\Tests\Framework\Unit_Test_Case;
use Brain\Monkey\Functions;
use WP_Rig\WP_Rig\Sidebars\Component;

/**
 * Class unit-testing the Sidebars component.
 *
 * @group sidebars
 */
class Component_Test extends Unit_Test_Case {
	...
	/**
	 * The Sidebars component instance.
	 *
	 * @var Component
	 */
	private $component;
	 ...
	 *
	 * @covers \WP_Rig\WP_Rig\Sidebars\Component::get_slug()
	 */
	public function test_get_slug() {
		$this->assertSame( 'sidebars', $this->component->get_slug() );
	}

	/**
	 * Tests that is_active() returns false when themeType is block-based in config.
	 *
	 * @covers \WP_Rig\WP_Rig\Sidebars\Component::is_active()
	 */
