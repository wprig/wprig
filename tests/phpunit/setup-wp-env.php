...
class WP_Test_Setup {
	...
	public function __construct() {
		...
		$this->wp_tests_dir = str_replace(['/', '\\'], DIRECTORY_SEPARATOR, $this->wp_tests_dir);
		$this->wp_core_dir = str_replace(['/', '\\'], DIRECTORY_SEPARATOR, $this->wp_core_dir);
	}
...
try {
	...
	if (file_exists($test_dir . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . 'bootstrap.php')) {
		...
		$marker_file = dirname(__FILE__) . DIRECTORY_SEPARATOR . '.wp-tests-setup-complete';
